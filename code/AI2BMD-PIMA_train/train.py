...
def get_args():
    ...
    parser.add_argument('--ind-block', default=True, action=argparse.BooleanOptionalAction, help='If true, append the ind block')
    parser.add_argument('--ind-num-layers', type=int, default=3, help='Number of interaction layers in the model')
    parser.add_argument('--mask-ind', default=False, action=argparse.BooleanOptionalAction, help='If true, mask fragment index before ind block')
    parser.add_argument('--mask-pole', default=False, action=argparse.BooleanOptionalAction, help='If true, mask fragment index before output block')
