...
def get_args():
    ...
    parser.add_argument('--PIMA_Block', type=bool, default=True, help='PIMA Block')
    parser.add_argument('--PIMA_charge_charge', type=bool, default=False, help='PIMA Type')
...
def main():
    ...
    if args.dataset != 'MD22':
        emae = emae / (kcal/mol)
        fmae = fmae / (kcal/mol)
    print('Energy MAE: {:.4f} kcal/mol'.format(emae))
    if args.derivative:
        print('Forces MAE: {:.4f} kcal/mol/A'.format(fmae))
