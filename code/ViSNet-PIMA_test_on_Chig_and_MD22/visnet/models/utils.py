...
class InteractionMatrix(nn.Module):  
    ...
    def get_ind_edge_index(self,pos, batch):
        return radius_graph(pos, r=IND_RADIUS, batch=batch, loop=False, max_num_neighbors=IND_MAX_NEIGHBORS)
...
class VecLayerNorm(nn.Module):
    ...
    def forward(self, vec):
        ...
        if vec.shape[1] == 3:
            ...
            raise ValueError("VecLayerNorm only support 3 , 4, 8 or 12 channels")
